...
export default class Player extends Phaser.Physics.Arcade.Sprite {
  constructor(scene, x, y, key, frame) {
    ...
    this.keys = {
      ...
      run: this.scene.input.keyboard.addKey(
  ...
  control_handler() {
    ...
    if ((this.cursors.down.isDown || this.keys.duck.isDown) && this.cursors.left.isDown) {
      this.body.setVelocityX(-80);
      this.anims.play("duck-left", true);
    }
    if ((this.cursors.down.isDown || this.keys.duck.isDown)&& this.cursors.right.isDown) {
      this.body.setVelocityX(80);
      this.anims.play("duck-left", true);
    }
