...
import SplashImg from "./assets/desertRushSplash.png";
...
import SlopedPlatformLeft from './game/slopedplatforms-left';
import ForestGroundSlantLeftImg from './assets/ground_grass_slant-left-img.png';
//import ForestGroundSlantRightImg from './assets/ground_grass_slant-right-img.png';
...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('splashlogo', SplashImg);
    ...
    this.load.image("platform-slant-left", ForestGroundSlantLeftImg);
    //this.load.image("platform-slant-right",ForestGroundSlantRightImg);
    ...
    this.load.json("level_slant-platforms-left", "src/leveldata/level_slant-platforms.json");
  ...
  create(data) {
    ...
    //--------------Platform Data Forest---------------------------------
        ...
        this.levelData_Ground_Slant_Left = this.cache.json.get("level_slant-platforms-left");
        //this.levelData_Ground_Slant_Right = this.cache.json.get("level_ground");
        //this.levelData_Ground_Slant_Right = this.cache.json.get("level_slant-platforms");
        ...
        this.platform_slant_left = this.physics.add.staticGroup();
        this.platform_slant_left.enableBody = true;
        ...
        //this.levelData_Ground_Slant_Left.platformSlantLeftData.forEach((element) => {
        //  this.platforms.create(element.x, element.y, "platform-slant-left");
        //});
        //this.levelData_Ground_Slant_Right.platformSlantLeftData.forEach((element) => {
        //  this.platforms.create(element.x, element.y, "platform-slant-right");
       // });
        this.physics.add.collider(this.platforms, this.player);
        this.physics.add.collider(this.ground_sand, this.player);
        this.physics.add.collider(this.platform_slant_left, this.player);
    ...
    this.platform_slant_left = [];
    this.levelData_Ground_Slant_Left.platformSlantLeftData.forEach((element) => {
      this.platform_slant_left.push(
        new SlopedPlatformLeft(this, element.x, element.y, "level_slant-platforms-left", element.scale)
      );
    });
    //this.platform_slant_right = [];
    //this.levelData_Ground_Slant_Right.platformSlantRightData.forEach((element) => {
     // this.platform_slant_right.push(
     //   new SlopedPlatform(this, element.x, element.y, "level_ground", element.scale)
    //  );
   // });
    this.mPlatform = [];
...
let monsters=this.monsters.getChildren();
    for(let i=0;i<monsters.length;i++){
             monsters[i].checkMonsterMovement();

      
      if((monsters[i])&&(monsters[i].health<=0)){
        this.monsters.remove(monsters[i]);
        continue
    ...
    for(let i=0;i<this.Plunger.length;i++){
      ...
      console.log(this.Plunger[i].health)
    }
  }
